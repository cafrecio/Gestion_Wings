...
verificadas por navegador e integradas en `main` (`9b212c0`). COB-04 incluyo una
correccion posterior verificada en copia aislada: pantalla y cobro usan ahora un solo
calculo del importe con descuento. COB-07 solo tiene comprobado su caso basico; COB-05
lo cruza con descuento. Evidencia en `docs/06-pruebas/`.
...
| **Tests** | **153 pruebas**, 860 aserciones, verde sobre MariaDB el 11/09 |
