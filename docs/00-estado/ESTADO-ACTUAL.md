...
| **Tests** | **279 pruebas**, 1585 aserciones; suite completa el 21/09 en wings_testing. Pasan contraseñas, recibos, FIN-10, FIN-11, ENT-05, SEG-11, FIN-06, FIN-13, FIN-09, FIN-12 (concurrencia de cancelación y pago con dos conexiones MariaDB), el seeder de primera carga y el endpoint de avisos de CSP |
