...
```bash
php artisan test          # 214 pruebas deben pasar
```

Corte verificado del 13/09: **214 pruebas**, todas verdes.
Suite completa el 13/09: 214 pruebas / 1311 aserciones; incluye FIN-10, FIN-11, SEG, ENT-05
