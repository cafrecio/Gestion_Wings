...
Suite local actual: 315 pruebas / 1804 aserciones (22/09), en verde. La lista
...
```bash
php artisan test          # 315 pruebas deben pasar
```

Corte verificado del 22/09: **315 pruebas / 1804 aserciones**, todas verdes; base descartable exclusiva.
