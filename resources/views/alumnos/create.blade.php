...
<div class="max-w-3xl mx-auto">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h1 class="text-xl font-semibold text-wings">Nuevo Alumno</h1>
    </div>
    ...
    <div class="glass-card p-6">
        <form method="POST" action="{{ route('web.alumnos.store') }}">
            ...
            <div class="flex items-center gap-3 mt-6 pt-4" style="border-top: 1px solid rgba(255,255,255,0.06);">
                ...
                <a href="{{ route('web.alumnos.index') }}" class="px-6 py-2.5 text-sm glass-card-sm text-wings-muted hover:text-white transition-colors">
                    Cancelar
                </a>
            </div>
        </form>
